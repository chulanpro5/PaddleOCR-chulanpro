...
huggingface-cli download chulanpro5/checkpoints \
  --repo-type dataset \
  --include "det_db_large_exp_6/*" \
  --local-dir ./output/ \
  --token=<token>
...
python3 -m paddle.distributed.launch --gpus '0,1,2,3,4,5,6,7' --log_dir ./output/det_db_large_exp_6/logs tools/train.py --config configs/det/PP-Thesis/HisDoc1B/det_db_large_exp_6/det_db_large_exp_6_3.yml
